...
| Cloud folder sync | Point Silo at a folder inside iCloud Drive, Dropbox, Google Drive, or OneDrive to keep your groups, tabs, and settings synced across machines. No backend or account required. |
