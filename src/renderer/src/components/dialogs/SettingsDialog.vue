...
<template>
  <Teleport to="body">
    ...
    >
      <div
        class="bg-surface-raised rounded-lg shadow-xl border border-border-default w-[480px] max-h-[80vh] flex flex-col"
      >
        <!-- Header -->
        <div class="flex items-center justify-between px-6 py-4 border-b border-border-default">
          <h2 class="text-lg font-semibold text-fg-primary">Settings</h2>
          <button
            @click="close"
