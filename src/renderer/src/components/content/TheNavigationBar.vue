...
function closeChildTab(childId: string): void {
  if (uiStore.confirmCloseChildTabs) {
    uiStore.openConfirmRemoveTabDialog(childId, true)
  } else {
    topbarStore.removeChildTab(childId)
  }
}
  ...
  >
    ...
    >
      ...
      >
        ...
        <button
          @click.stop="closeChildTab(child.id)"
